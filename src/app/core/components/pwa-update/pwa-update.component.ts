        ...
        <div class="status-content">
          <div class="status-info">
            ...
            <div class="status-item" *ngIf="isPwaEnabled">
              ...
              <p-badge [value]="swStatus" [severity]="getSwStatusSeverity()">
              </p-badge>
            </div>
...
export class PwaUpdateComponent implements OnInit {
  ...
  forceReload() {
    if (
      confirm(
        'This will reload the application. Any unsaved changes will be lost. Continue?'
      )
    ) {
...
🔄 Last Update Check: ${
      this.lastChecked ? this.lastChecked.toLocaleString() : 'Never'
    }
